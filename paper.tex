...
The benchmark corpus, gold-standard models, harness, and kUML itself are released as open source, and we invite the community to extend the corpus with additional diagram families, target DSLs, and models. The three-model full study remains outstanding; the evidence so far, however, already supports a simple practical recommendation: when LLMs write your models, let a compiler read them first.
